...
<figure style="display: flex; flex-wrap: wrap; justify-content: center; gap: 10px;">
    <img src="{{site.baseurl}}/assets/images/project/ss_1.png" style="flex: 1 1 48%; max-width: 48%; height: auto;">
    <img src="{{site.baseurl}}/assets/images/project/ss_2.png" style="flex: 1 1 48%; max-width: 48%; height: auto;">
</figure>
<br>
